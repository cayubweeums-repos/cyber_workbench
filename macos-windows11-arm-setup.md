...
Create the autounattend.xml file for unattended installation or use the one included in this repo. **Important:** Save this file as `autounattend.xml` (exactly this name).
